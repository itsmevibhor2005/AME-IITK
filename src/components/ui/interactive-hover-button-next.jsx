...
export const InteractiveHoverButtonRight = React.forwardRef(({ children, className, ...props }, ref) => {
  return (
    (<button
      ref={ref}
      className={cn(
...
InteractiveHoverButtonRight.displayName = "InteractiveHoverButtonRight";
