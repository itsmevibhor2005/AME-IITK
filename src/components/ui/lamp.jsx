...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative flex min-h-[95vh] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative top-[-7vh] flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
